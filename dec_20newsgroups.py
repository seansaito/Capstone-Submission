...
def DisKmeans(db, update_interval = None):
    ...
    while True:
        ...
        if iters == 0:
            ...
            ret, net = extract_feature('20newsgroups_net.prototxt',
            ...
            ret, net = extract_feature('20newsgroups_net.prototxt', '20newsgroups_init.caffemodel', ['output'], N, True, 0)
            feature = ret[0].squeeze()
        ...
        net.save('20newsgroups_init.caffemodel')
        del net

        with open('20newsgroups_solver.prototxt', 'w') as fsolver:
            fsolver.write("""net: "20newsgroups_net.prototxt"
                base_lr: 0.01
                lr_policy: "step"
                gamma: 0.1
                stepsize: 100000
                ...
                weight_decay: 0.0000
                snapshot: 100
                snapshot_prefix: "exp/20newsgroups_test/save"
        ...
        os.system('caffe train --solver=20newsgroups_solver.prototxt --weights=20newsgroups_init.caffemodel')
        shutil.copyfile('exp/20newsgroups_test/save_iter_%d.caffemodel'%update_interval, '20newsgroups_init.caffemodel')
...
def write_net(db, dim, n_class, seek):
    ...
    with open('20newsgroups_net.prototxt', 'w') as fnet:
